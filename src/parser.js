// This is in JavaScript because acorn does not provide
// a complete declaration file
import { Parser, tokTypes as tt, keywordTypes, lineBreak, isIdentifierChar } from 'acorn'
import { getLanguageWordsRegExp, getLanguageSynonyms, getLanguageSynonym, getJavaScriptSynonym, areSynonyms } from './utilities'

export {
    Node as AcornNode,
    SourceLocation as AcornSourceLocation,
    Position as AcornPosition,
    tokTypes as TokenType,
    keywordTypes as KeywordTokenType
} from 'acorn'

export const textToTokenType = {
    ...keywordTypes,
    '[': tt.bracketL,
    ']': tt.bracketR,
    '{': tt.braceL,
